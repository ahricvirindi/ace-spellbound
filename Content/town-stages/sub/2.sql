...
INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x701C904C, 44076, 0x01C9022D, 66.026, -26.053, 0.005, -0.394543, 0, 0, 0.918877, False, '2024-05-12 18:00:23'); /* Laurana */
/* @teleloc 0x01C9022D [66.026001 -26.052999 0.005000] -0.394543 0.000000 0.000000 0.918877 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x701C904D, 43065, 0x01C9023B, 88.78001, -47.85611, -0.063, 0.909446, 0, 0, 0.415823, False, '2024-05-12 18:01:44'); /* Portal to Town Network */
/* @teleloc 0x01C9023B [88.780006 -47.856110 -0.063000] 0.909446 0.000000 0.000000 0.415823 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x701C904E,   509, 0x01C90236, 75.68034, -50.42338, 0, 0.995779, 0, 0, -0.09178, False, '2024-05-12 18:09:24'); /* Life Stone */
/* @teleloc 0x01C90236 [75.680344 -50.423382 0.000000] 0.995779 0.000000 0.000000 -0.091780 */
